<template>
  <div class="container">
    <div class="flex flex-col gap-10">
      <div class="flex flex-col items-start gap-4 w-2/5">
      ...
      <div class="grid grid-cols-2 place-items-center">
        <div>
          <mpImage
            ...
            :imgStyle="'w-full  items-center'"
            altText="arrow_down"
          />
        </div>
        <Card cardStyle="lg:w-full md:w-2/3 sm:w-full shadow-md">
          <div class="flex flex-col justify-between items-start">
            <div
              class="xl:w-[540px] h-[108px] px-5 flex flex-row items-center justify-between border-[1px] rounded-[16px] border-mpGrey200 bg-mpGrey100"
            >
              <div class="py-5 px-2">
                <label
              ...
              <div>
                ...
                >
                  <mpImage
                    ...
                    altText="arrow_down"
                  />
                  <h1 class="text-secondary font-medium text-base mx-2">USD</h1>
                  <mpImage
            ...
            <div
              class="xl:w-[540px] z-10 -mt-6 h-[108px] px-5 flex flex-row items-center justify-between border-[1px] rounded-[16px] border-mpGrey200 bg-mpGrey100"
            >
              <div class="py-5 px-2">
              ...
              <div>
                ...
                >
                  <mpImage
                    ...
                    altText="arrow_down"
                  />
                  <h1 class="text-secondary font-medium text-base mx-2">NGN</h1>
                  <mpImage
                    :path="Images.arrowDwn_icon"
                    :imgStyle="'w-4 items-center'"
                    altText="arrow_down"
